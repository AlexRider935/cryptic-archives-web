// File: web/src/app/dashboard/cases/components/CaseCover.jsx

import Image from "next/image";
import Link from "next/link";
import { FileText, Shield } from "lucide-react";

export const CaseCover = ({ caseData }) => {
  // If no case is selected, show a prompt.
  if (!caseData) {
    return (
      <div className="paper-background p-12 text-center flex items-center justify-center h-full">
        <p className="font-serif text-2xl text-gray-500">
          Select a dossier from the archives to review its cover.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="paper-background p-12 h-full flex flex-col justify-between">
      <div>
